...
import 'package:InventoryWhiz/resources/models/common_model.dart';
import 'package:InventoryWhiz/screens/forgot_password/bloc/forget_password_bloc.dart';
import 'package:InventoryWhiz/screens/register/bloc/register_bloc.dart';
...
class _PasswordVerifyOtpState extends State<PasswordVerifyOtp>
    with CacheManager {
  var email = '';
  String firstPart = '';
  String secondPart = '';
                                  ...
                                  onPressed: () async {
                                    if (token.length != 4 || token.isEmpty) {
                                      ...
                                      if (forgetPasswordBloc
                                              .forgetOtpModel.statusCode ==
                                          200) {
                                        _snackBar(
                                            "Message",
                                            forgetPasswordBloc
                                                .forgetOtpModel.message);
                                        Get.to(() => NewPassword(),
                                            arguments: email);
                                      } else if (forgetPasswordBloc
                                              .forgetOtpModel.statusCode ==
                                          401) {
                                        _snackBar(
                                            "Message",
