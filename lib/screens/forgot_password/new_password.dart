...
import 'package:InventoryWhiz/screens/login/sign_in.dart';
                  ...
                  child: InkWell(
                    onTap: () async {
                      if (formKey.currentState!.validate()) {
                        ...
                        await forgetPasswordBloc.forgetPasswordRequest(
                            email, password, confirmPassword);

                        Navigator.of(context).pop();

                        if (forgetPasswordBloc.forgetPasswordModel.statusCode ==
                            200) {
                          _snackBar("Message",
                              forgetPasswordBloc.forgetPasswordModel.message);
                          Get.offAll(() => SignIn());
                        } else if (forgetPasswordBloc
                                .forgetPasswordModel.statusCode ==
                            401) {
                          _snackBar("Message",
                              forgetPasswordBloc.forgetPasswordModel.message);
                        } else {
